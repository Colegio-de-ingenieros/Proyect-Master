...
class MostrarOfertas{
    ...
    function getOfertas($rfc){
        $querry = "SELECT bolsaempresa.IdEmpBol, VacEmpBol, ReqAcaEmpBol, AñoEmpBol,TelEmpBol 
        FROM bolsaempresa, usuaempbolsa 
        WHERE bolsaempresa.IdEmpBol=usuaempbolsa.IdEmpBol and usuaempbolsa.RFCUsuaEmp=:rfc";
    ...
    function buscador($busqueda,$rfce){
        $querry = "SELECT bolsaempresa.IdEmpBol, VacEmpBol, ReqAcaEmpBol, AñoEmpBol,TelEmpBol FROM bolsaempresa ,usuaempbolsa
        WHERE (bolsaempresa.IdEmpBol=usuaempbolsa.IdEmpBol and usuaempbolsa.RFCUsuaEmp=:rfc) and VacEmpBol LIKE :busqueda OR TelEmpBol LIKE :busqueda";
