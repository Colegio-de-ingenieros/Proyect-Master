...
class MostrarCertificaciones{
    ...
    //busca el recio con la fecha mas reciente de la certificacion que recibe
    function buscarUltimoPrecio($idc){
        ...
        $querry = "SELECT * FROM historico, certh WHERE (certh.IdCerInt = :id AND certh.IdH = historico.IdH AND FechaH = :fecha) ";
