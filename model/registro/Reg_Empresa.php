...
class Alta_empresa extends Crud_bd{
    ...
    {   
        ...
        $cuerpo = "<p>La empresa ".$nombre ." ahora es asociado del Colegio de Ingenieros en Sistemas Computacionales. Este será su número inteligente: ".$numero_inteligente."</p>";
