<?php
    ...
    class mostrarCursos extends Crud_bd{
        ...
        public function tabla_completa($id_curso){
            ...
            $consulta = "SELECT altacursos.IdCurPerso, NomCurPerso, HraCurPerso, OrgCurPerso, EstatusCurPerso, ComeCurPerso  FROM altacursos, persoaltacur WHERE persoaltacur.IdCurPerso=altacursos.IdCurPerso and persoaltacur.IdPerso = :user";
        ...
        public function inteligente($id_curso, $busqueda){
            ...
            $consulta = "SELECT altacursos.IdCurPerso, NomCurPerso, HraCurPerso, OrgCurPerso, EstatusCurPerso, ComeCurPerso  FROM altacursos, persoaltacur WHERE persoaltacur.IdCurPerso=altacursos.IdCurPerso and persoaltacur.IdPerso = :user and 
