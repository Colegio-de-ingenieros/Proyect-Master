...
if ($resultado == true) {
    ...
    for ($i = 0; $i < count($resultado); $i++) {
        ...
        $salida .= '<td><a class="table_item__link" href="../../controller/administrativo/editarTrabajador.php?rfc='.$rfc.'" onclick="return confirmacion()">Editar</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a class="table_item__link" href="../../controller/administrativo/Eliminar_Trabajadores.php?rfc='.$rfc.'" onclick="return confirmacion()" >Eliminar</a></td>';
        $salida .= '</tr></div>';
