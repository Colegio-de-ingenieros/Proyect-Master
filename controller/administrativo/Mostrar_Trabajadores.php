...
if ($resultado == true) {
    ...
    for ($i = 0; $i < count($resultado); $i++) {
        ...
        $salida .= '<td><a href="../../view/administrativo/Modi_Trabajadores.html?rfc='.$rfc.'" >Modificar</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="../../controller/administrativo/Eliminar_Trabajadores.php?rfc='.$rfc.'" class="table_item__link">Eliminar</a></td>';
        //
        //
        $salida .= '</tr></div>';
