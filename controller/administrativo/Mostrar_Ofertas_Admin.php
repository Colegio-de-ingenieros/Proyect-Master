...
if (isset($_POST['consulta'])) {
    ...
    if ($resultado == true) {
        ...
        <table class="header_table" >
            ...
            $salida .= '<td><a href="../../controller/administrativo/Mostrar_Oferta_Individual.php?id='.$id.'" >Más...</a>&nbsp;&nbsp;&nbsp;<a href="../../view/administrativo/Vista_CvAdmin.html?id='.$id.'" >Aplicantes</a></td>';
            //
            //
            $salida .= '</tr></div>';
