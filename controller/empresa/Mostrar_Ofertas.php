...
if (isset($_POST['consulta'])) {
    ...
    if ($resultado == true) {
        ...
        for ($i = 0; $i < count($resultado); $i++) {
            ...
            $salida .= '<td><a href="../../controller/empresa/Mostrar_Oferta_Individual.php?id='.$id.'" >Más...</a>&nbsp;&nbsp;&nbsp;<a href="../../view/empresa/Vista_Aplicantes.php?id='.$id.'" >Aplicantes</a>&nbsp;&nbsp;&nbsp;<a href="#" onclick="confirmDesactiv(String('.$id.'))" class="table_item__link">Eliminar</a></td>';
            //
    ...
    if ($resultado == true) {
        ...
        for ($i = 0; $i < count($resultado); $i++) {
            ...
            $salida .= '<td>' .$aplica. '</td>';
            $salida .= '<td>' .$estatus. '</td>';            
            $salida .= '<td><a href="../../controller/empresa/Mostrar_Oferta_Individual.php?id='.$id.'" >Más...</a>&nbsp;&nbsp;&nbsp;<a href="../../view/empresa/Vista_Aplicantes.html?id='.$id.'" >Aplicantes</a>&nbsp;&nbsp;&nbsp;<a href="#" onclick="confirmDesactiv(String('.$id.'))" class="table_item__link">Eliminar</a></td>';
